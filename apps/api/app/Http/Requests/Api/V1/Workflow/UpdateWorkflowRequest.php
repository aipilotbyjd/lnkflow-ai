...
class UpdateWorkflowRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'trigger_type' => ['sometimes', 'required', Rule::enum(TriggerType::class)],
            'trigger_config' => ['nullable', 'array'],
            'trigger_config.cron' => ['nullable', 'string'],
            'trigger_config.timezone' => ['nullable', 'string', 'timezone'],
            'trigger_config.path' => ['nullable', 'string', 'max:100', 'regex:/^[a-z0-9\-_]+$/i'],
